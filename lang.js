    ...
    constructor() {
        ...
        this.translations = {
            ja: {
                ...
                'court-search-desc': '地区・市区・区間・民間施設まで、全国のバレーボールコートを検索・予約できます。',
            ...
            'court-benchakitti': 'ベンチャキティ スポーツセンター',
            'court-benchakitti-location': 'Khlong Toei, Bangkok',
            'court-cu-sports': 'CU Sports Complex',
            'court-cu-location': 'Pathum Wan, Bangkok',
            'court-lumpini': 'Lumpini Recreation Center',
            'court-lumpini-location': 'Pathum Wan, Bangkok',
            'court-asoke': 'Asoke Sports Club',
            'court-asoke-location': 'Watthana, Bangkok',
            'per-hour': '時間',
            'reviews-count': '件',
            'event-beginner-practice': '初心者歓迎！バレーボール練習会',
            'event-location-benchakitti': 'ベンチャキティ スポーツセンター - Khlong Toei',
            'event-intermediate-practice': '中級者向けゲーム練習',
            'event-location-cu-sports': 'CU Sports Complex - Pathum Wan, Bangkok',
            'event-women-tournament': '女性限定バレーボール大会',
            'event-location-lumpini': 'Lumpini Recreation Center - Pathum Wan, Bangkok',
            'level-beginner': '初心者',
            ...
            th: {
                ...
                // Main page
                'hero-title': 'การเชื่อมต่อและการบ่มเพาะ: วอลเลย์บอลเพื่อการเอาชีวิตรอด',
                ...
                'court-search-desc': 'ค้นหาและจองสนามวอลเลย์บอลทั่วประเทศ จากเขต อำเภอ ไปจนถึงสถานที่เอกชน',
                ...
                // Courts
                'court-benchakitti': 'ศูนย์กีฬาเบญจกิติ',
                'court-benchakitti-location': 'คลองเตย กรุงเทพฯ',
                'court-cu-sports': 'อาคารเฉลิมราชสุดากีฬาสถาน',
                'court-cu-location': 'ปทุมวัน กรุงเทพฯ',
                'court-lumpini': 'ศูนย์นันทนาการลุมพินี',
                'court-lumpini-location': 'ปทุมวัน กรุงเทพฯ',
                'court-asoke': 'Asoke Sports Club',
                'court-asoke-location': 'วัฒนา กรุงเทพฯ',
                
                // Events
                'event-beginner-practice': 'การฝึกซ้อมวอลเลย์บอลสำหรับผู้เริ่มต้น!',
                'event-location-benchakitti': 'ศูนย์กีฬาเบญจกิติ - คลองเตย',
                'event-intermediate-practice': 'การฝึกซ้อมเกมระดับกลาง',
                'event-location-cu-sports': 'อาคารเฉลิมราชสุดากีฬาสถาน - ปทุมวัน กรุงเทพฯ',
                'event-women-tournament': 'การแข่งขันวอลเลย์บอลสำหรับผู้หญิงเท่านั้น',
                'event-location-lumpini': 'ศูนย์นันทนาการลุมพินี - ปทุมวัน กรุงเทพฯ',
